    ...
    private void processChatRoomPush(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                message.setId(datObj.getString("idmessage"));
                ...
                if (datObj.getString("iduser").equals(User.getCurrentUser(getApplicationContext()).getId())) {
                    Log.e(TAG, "Skipping the push message as it belongs to same user");
                    return;
                }

                User user = new User();
                user.setId(datObj.getInt("iduser"));
                user.setEmail(datObj.getString("email"));
