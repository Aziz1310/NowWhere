...
import com.maher.nowhere.CentreActivity.fragments.products.ProductsPresenter;
 ...
 */
public class TrynowFragment extends Fragment implements TryNowView {
    ...
    private ArrayList<Pack> trynow;
    Owner owner;
    TrynowAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TryNowPresenter tryNowPresenter = new TryNowPresenter(this, getActivity());
        tryNowPresenter.getListPacks(owner.getId());

        trynow = new ArrayList<>();
        lm = new LinearLayoutManager(getActivity(), LinearLayout.VERTICAL, false);
        mAdapter = new TrynowAdapter(getActivity(), trynow);
    ...
    @Override
    public void loadAllPacks(ArrayList<Pack> packs) {
        trynow = packs;
        mAdapter = new TrynowAdapter(getActivity(), trynow);
        recyclerView.setAdapter(mAdapter);
    ...
    @Override
    public void loadNoPack(ArrayList<Pack> packs) {
        trynow = packs;
        mAdapter = new TrynowAdapter(getActivity(), trynow);
        recyclerView.setAdapter(mAdapter);
    }
