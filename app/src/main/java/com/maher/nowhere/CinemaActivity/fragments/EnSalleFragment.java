 ...
 * {@link EnSalleFragment.OnFragmentInteractionListener} interface
...
public class EnSalleFragment extends Fragment {
    ...
    private ArrayList<EnSalle> enSalles;
    ...
    public static EnSalleFragment newInstance(String param1, String param2) {
        EnSalleFragment fragment = new EnSalleFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enSalles = new ArrayList<>();
        enSalles.add(new EnSalle());
        enSalles.add(new EnSalle());
        enSalles.add(new EnSalle());

        lm=new LinearLayoutManager(getActivity(), LinearLayout.VERTICAL,false);
        recyclerView.setLayoutManager(lm);
        EnSalleAdapter enSalleAdapter = new EnSalleAdapter(getActivity(), enSalles);
